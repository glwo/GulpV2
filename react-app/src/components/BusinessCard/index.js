    ...
    <Link className="businessCard-main-div" to={`/business/${business.id}`}>
      <div className="image-div">
        <img
          ...
          src={
            business.business_images[0] !== undefined
              ? business.business_images[0].image_url
              : null
          }
          onError={(e) => {
            e.target.src = "https://he.cecollaboratory.com/public/layouts/images/community-default-logo.png"; // Replace 'path_to_default_image.jpg' with the actual path to your default image
          }}
      ...
      <div className="businessInfoDiv">
        ...
        <div>
          {business.avg_rating >= 1 ? (
            <i className="fas fa-solid fa-star red"></i>
          ) : (
            <i className="fas fa-solid fa-star gray"></i>
          )}
          {business.avg_rating >= 2 ? (
            <i className="fas fa-solid fa-star red"></i>
          ) : (
            <i className="fas fa-solid fa-star gray"></i>
          )}
          {business.avg_rating >= 3 ? (
            <i className="fas fa-solid fa-star red"></i>
          ) : (
            <i className="fas fa-solid fa-star gray"></i>
          )}
          {business.avg_rating >= 4 ? (
            <i className="fas fa-solid fa-star red"></i>
          ) : (
            <i className="fas fa-solid fa-star gray"></i>
          )}
          {business.avg_rating >= 5 ? (
            <i className="fas fa-solid fa-star red"></i>
          ) : (
            <i className="fas fa-solid fa-star gray"></i>
          )}
